...
if __name__ == '__main__':
    ...
    model_path = './checkpoints/cls_pplus/{}.pt'.format(args.load_checkpoint)
    ...
    for idx in range(len(test_data)):
        # pdb.set_trace()
        viz_seg(test_data[idx].cpu(), test_label[idx].cpu(), "{}/cls_pplus/gt_{}_{}.gif".format(args.output_dir, args.exp_name, idx), args.device)
        viz_seg(test_data[idx].cpu(), pred_label[idx].cpu(), "{}/cls_pplus/pred_{}_{}.gif".format(args.output_dir, args.exp_name, idx), args.device)
